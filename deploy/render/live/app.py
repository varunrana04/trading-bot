    ...
    def start_bot(self):
        ...
        try:
            ...
            try:
                ...
                test_resp = requests.get(test_url, params={"symbol": "BTCUSDT", "interval": "1h", "limit": 1}, timeout=10)
                self.log(f"📡 Direct API test: Status {test_resp.status_code}")
                if test_resp.status_code != 200:
                    self.log(f"   Response: {test_resp.text[:200]}")
